...
public class CarController_3 : MonoBehaviour
{
    ...
    void MoveToWaypoint()
    {
        ...
        // Käännetään auto vain, jos suuntavektori ei ole nolla
        if (direction != Vector3.zero)
        {
            // Lasketaan kohdesuunta — +180 astetta korjaa mallin suunnan
        ...
        // Liikutetaan auto tasaisesti kohti seuraavaa reittipistettä
        // MoveTowards ei mene koskaan ohi kohteesta
